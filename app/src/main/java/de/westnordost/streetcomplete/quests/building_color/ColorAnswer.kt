...
sealed interface ColorOrIsStepsAnswer
object IsActuallyStepsAnswer : ColorOrIsStepsAnswer

data class ColorAnswer(val value: Color, val note: String? = null) : ColorOrIsStepsAnswer

fun ColorAnswer.applyTo(tags: Tags, key: String) {
